...
def _seed_sample_data(cursor):
    ...
    sample_events = [
        ("Tech Startup Meetup", "Technology", "HITEC City, Hyderabad", 17.4435, 78.3772,
         "2026-07-15", "Monthly networking meetup for startup founders and developers. Pitches, demos, and open discussion."),
        ("Classical Music Evening", "Music", "Ravindra Bharathi, Hyderabad", 17.4062, 78.4691,
         "2026-07-18", "An evening of classical Carnatic music by renowned artists. Open to all music lovers."),
        ("Food Festival Hyderabad", "Food & Drink", "Necklace Road, Hyderabad", 17.4146, 78.4738,
         "2026-07-20", "Celebrate Hyderabad's rich culinary culture with over 50 food stalls, live cooking demos, and competitions."),
        ("Photography Walk", "Arts", "Charminar, Hyderabad", 17.3616, 78.4747,
         "2026-07-22", "Guided photography walk through the historic old city. All skill levels welcome. Bring your camera!"),
        ("Yoga & Wellness Camp", "Health & Wellness", "KBR National Park, Hyderabad", 17.4239, 78.4244,
         "2026-07-24", "A rejuvenating morning yoga session followed by wellness workshops and healthy food stalls."),
        ("Open Mic Night", "Entertainment", "Jubilee Hills, Hyderabad", 17.4314, 78.4079,
         "2026-07-25", "Open mic event for stand-up comedians, poets, and musicians. Sign up at the venue."),
        ("Python Workshop", "Technology", "T-Hub, Hyderabad", 17.4270, 78.3440,
         "2026-07-28", "Hands-on Python workshop for beginners. Topics: data analysis, automation, and web scraping."),
        ("Indie Art Exhibition", "Arts", "Lamakaan, Hyderabad", 17.4207, 78.4340,
         "2026-07-30", "Showcasing work from 20 independent Hyderabadi artists. Painting, sculpture, and digital art."),
        ("Marathon 2026", "Sports", "LB Stadium, Hyderabad", 17.3950, 78.4744,
         "2026-08-02", "Annual city marathon with 5K, 10K, and 21K categories. Register online to participate."),
        ("Book Club Meetup", "Education", "Crossword Bookstore, Hyderabad", 17.4484, 78.3873,
         "2026-08-05", "Monthly book club meetup. This month's book: 'The Alchemist'. Discussion and refreshments."),
        ("Street Dance Battle", "Entertainment", "Inorbit Mall, Hyderabad", 17.4333, 78.3817,
         "2026-08-07", "Inter-city street dance competition featuring hip-hop, breaking, and locking styles. Cash prizes!"),
        ("Startup Funding Summit", "Technology", "Novotel Hotel, Hyderabad", 17.4523, 78.3748,
         "2026-08-10", "Connect with VCs, angel investors, and fellow entrepreneurs. Panel discussions and 1:1 meetings."),
        ("Farmers Market", "Food & Drink", "Madhapur, Hyderabad", 17.4485, 78.3908,
         "2026-08-12", "Fresh organic produce, homemade goods, and artisanal foods directly from local farmers."),
        ("Cycling Event", "Sports", "Hussain Sagar, Hyderabad", 17.4239, 78.4738,
         "2026-08-14", "Morning cycling event around Hussain Sagar lake. All skill levels. Cycles available for rent."),
        ("AI & ML Conference", "Technology", "ISB Hyderabad", 17.5353, 78.3463,
         "2026-08-16", "Full-day conference on the latest in Artificial Intelligence and Machine Learning. 20+ speakers."),
    ]
    cursor.executemany("""
